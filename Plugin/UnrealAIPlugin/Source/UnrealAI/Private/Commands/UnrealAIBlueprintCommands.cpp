...
FUnrealAIBlueprintCommands::FUnrealAIBlueprintCommands()
{
}

TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleCommand(const FString& CommandType, const TSharedPtr<FJsonObject>& Params)
{
    ...
    return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Unknown blueprint command: %s"), *CommandType));
}

TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleCreateBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    ...
    {
        return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Blueprint already exists: %s"), *BlueprintName));
    }
    ...
    return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Failed to create blueprint"));
}

TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleAddComponentToBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    ...
    if (!Blueprint)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Blueprint not found: %s"), *BlueprintName));
    }
    ...
    {
        return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Unknown component type: %s"), *ComponentType));
    }
    ...
    if (NewNode)
    {
        ...
        if (SceneComponent)
        {
            ...
            {
                SceneComponent->SetRelativeLocation(FUnrealAICommonUtils::GetVectorFromJson(Params, TEXT("location")));
            }
            if (Params->HasField(TEXT("rotation")))
            {
                SceneComponent->SetRelativeRotation(FUnrealAICommonUtils::GetRotatorFromJson(Params, TEXT("rotation")));
            }
            if (Params->HasField(TEXT("scale")))
            {
                SceneComponent->SetRelativeScale3D(FUnrealAICommonUtils::GetVectorFromJson(Params, TEXT("scale")));
            }
        }
    ...
    return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Failed to add component to blueprint"));
}

TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleSetPhysicsProperties(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    ...
    if (!Params->TryGetStringField(TEXT("component_name"), ComponentName))
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Missing 'component_name' parameter"));
    }
    ...
    if (!ComponentNode)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Component not found: %s"), *ComponentName));
    }

    UPrimitiveComponent* PrimComponent = Cast<UPrimitiveComponent>(ComponentNode->ComponentTemplate);
    if (!PrimComponent)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Component is not a primitive component"));
    }
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleCompileBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleSpawnBlueprintActor(const TSharedPtr<FJsonObject>& Params)
{
    ...
    if (NewActor)
    {
        ...
        TSharedPtr<FJsonObject> Result = FUnrealAICommonUtils::ActorToJsonObject(NewActor, true);
    ...
    return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Failed to spawn blueprint actor"));
}

TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleSetStaticMeshProperties(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    ...
    if (!MeshComponent)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Component is not a static mesh component"));
    }
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleSetMeshMaterialColor(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
    ...
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("'color' must be an array of 4 float values [R, G, B, A]"));
    }
    ...
    if (Params->TryGetStringField(TEXT("material_path"), MaterialPath))
    {
        ...
        if (!Material)
        {
            return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Failed to load material: %s"), *MaterialPath));
        }
    }
    else
    {
        ...
        if (!Material)
        {
            ...
            if (!Material)
            {
                return FUnrealAICommonUtils::CreateErrorResponse(TEXT("No material found on component and failed to load default material"));
            }
        }
    }
    ...
    if (!DynMaterial)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Failed to create dynamic material instance"));
    }
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleGetAvailableMaterials(const TSharedPtr<FJsonObject>& Params)
{
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleApplyMaterialToActor(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString ActorName;
    if (!Params->TryGetStringField(TEXT("actor_name"), ActorName))
    ...
    if (!Params->TryGetStringField(TEXT("material_path"), MaterialPath))
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Missing 'material_path' parameter"));
    }
    ...
    if (!bAppliedToAny)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("No mesh components found on actor"));
    }
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleApplyMaterialToBlueprint(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleGetActorMaterialInfo(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString ActorName;
    if (!Params->TryGetStringField(TEXT("actor_name"), ActorName))
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleGetBlueprintMaterialInfo(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintName;
    if (!Params->TryGetStringField(TEXT("blueprint_name"), BlueprintName))
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleReadBlueprintContent(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    {
        return FUnrealAICommonUtils::CreateErrorResponse(TEXT("Missing 'blueprint_path' parameter"));
    }
    ...
    if (!Blueprint)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Failed to load blueprint: %s"), *BlueprintPath));
    }
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleAnalyzeBlueprintGraph(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    ...
    if (!TargetGraph)
    {
        return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Graph not found: %s"), *GraphName));
    }
    ...
    for (UEdGraphNode* Node : TargetGraph->Nodes)
    {
        if (Node)
        {
            ...
            NodeObj->SetStringField(TEXT("class"), Node->GetClass()->GetName());
            NodeObj->SetStringField(TEXT("title"), Node->GetNodeTitle(ENodeTitleType::FullTitle).ToString());
            // Phase 5 / C1: expose NodeGuid so the model can reference this
            // node from LinkedTo entries when authoring T3D edits.
            ...
            if (bIncludePinConnections)
            {
                ...
                for (UEdGraphPin* Pin : Node->Pins)
                {
                    if (Pin)
                    {
                        ...
                        // Phase 5 / C1: richer pin type info so the model can
                        // pick legal connections when wiring LinkedTo refs.
                        ...
                        {
                            PinObj->SetStringField(TEXT("sub_category_object"),
                                Pin->PinType.PinSubCategoryObject->GetPathName());
                        }
                        switch (Pin->PinType.ContainerType)
                        {
                            case EPinContainerType::Array: PinObj->SetStringField(TEXT("container"), TEXT("Array")); break;
                            case EPinContainerType::Set:   PinObj->SetStringField(TEXT("container"), TEXT("Set"));   break;
                            case EPinContainerType::Map:   PinObj->SetStringField(TEXT("container"), TEXT("Map"));   break;
                            default: break; // None — omit
                        }
                        if (Pin->PinType.bIsReference) { PinObj->SetBoolField(TEXT("is_reference"), true); }
                        if (Pin->PinType.bIsConst)     { PinObj->SetBoolField(TEXT("is_const"), true); }

                        PinObj->SetStringField(TEXT("pin_id"), Pin->PinId.ToString(EGuidFormats::Digits));
                        PinObj->SetStringField(TEXT("direction"), Pin->Direction == EGPD_Input ? TEXT("Input") : TEXT("Output"));
                        PinObj->SetNumberField(TEXT("connections"), Pin->LinkedTo.Num());

                        // Surface the default value for input pins so the
                        // model can see what's already wired.
                        if (Pin->Direction == EGPD_Input && !Pin->DefaultValue.IsEmpty())
                        {
                            PinObj->SetStringField(TEXT("default_value"), Pin->DefaultValue);
                        }
                        if (Pin->bHidden)        { PinObj->SetBoolField(TEXT("hidden"), true); }
                        if (Pin->bAdvancedView)  { PinObj->SetBoolField(TEXT("advanced"), true); }
                        ...
                        for (UEdGraphPin* LinkedPin : Pin->LinkedTo)
                        {
                            if (LinkedPin && LinkedPin->GetOwningNode())
                            {
                                ...
                                ConnObj->SetStringField(TEXT("from_pin_id"), Pin->PinId.ToString(EGuidFormats::Digits));
                                ...
                                ConnObj->SetStringField(TEXT("to_pin_id"), LinkedPin->PinId.ToString(EGuidFormats::Digits));
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleGetBlueprintVariableDetails(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    ...
    if (bSpecificVariable)
    {
        ...
        {
            return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Variable not found: %s"), *VariableName));
        }
    }
    else
    {
...
TSharedPtr<FJsonObject> FUnrealAIBlueprintCommands::HandleGetBlueprintFunctionDetails(const TSharedPtr<FJsonObject>& Params)
{
    // Get required parameters
    FString BlueprintPath;
    if (!Params->TryGetStringField(TEXT("blueprint_path"), BlueprintPath))
    ...
    if (bSpecificFunction)
    {
        ...
        {
            return FUnrealAICommonUtils::CreateErrorResponse(FString::Printf(TEXT("Function not found: %s"), *FunctionName));
        }
    }
    else
    {
