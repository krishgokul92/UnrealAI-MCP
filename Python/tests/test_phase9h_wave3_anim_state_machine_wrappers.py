"""Wrapper coverage for Phase 9h Wave 3 named state-machine inspection."""
...
def test_read_anim_state_machine_maps_payload(monkeypatch):
    ...
    response = mcp.read_anim_state_machine(
    ...
    assert captured == {
        "command": "read_anim_state_machine",
        "payload": {
            "asset_path": "/Game/CopilotTests/AnimBlueprints/ABP_Test.ABP_Test",
            "state_machine_name": "Locomotion",
        },
