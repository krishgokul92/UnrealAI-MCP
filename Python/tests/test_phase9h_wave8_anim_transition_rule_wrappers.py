"""Wrapper coverage for Phase 9h Wave 8 transition rule helpers."""
...
def test_set_anim_transition_rule_maps_payload(monkeypatch):
    ...
    response = mcp.set_anim_transition_rule(
    ...
    assert captured == {
        "command": "set_anim_transition_rule",
        "payload": {
            "asset_path": "/Game/CopilotTests/AnimBlueprints/ABP_Test.ABP_Test",
            "state_machine_name": "Traversal",
            "source_state_name": "Idle",
    ...
    assert payload["rule_type"] == "int_equals"
