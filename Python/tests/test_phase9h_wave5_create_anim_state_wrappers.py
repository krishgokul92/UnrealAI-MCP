"""Wrapper coverage for Phase 9h Wave 5 state creation."""
...
def test_create_anim_state_maps_payload(monkeypatch):
    ...
    response = mcp.create_anim_state(
