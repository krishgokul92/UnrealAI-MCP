"""Pure-Python wrapper tests for the Phase 9d landscape height-region slice."""
...
def test_sample_landscape_height_region_maps_payload(monkeypatch):
    calls = _capture_bridge(monkeypatch)

    result = mcp_module.sample_landscape_height_region(
        "Landscape_Main",
        [100.0, 200.0, 300.0],
        [740.0, 920.0, 300.0],
        320.0,
