"""Pure-Python wrapper tests for Phase 9f Wave 2 camera-cut track helpers."""
...
def test_add_camera_cut_track_to_level_sequence_maps_payload(monkeypatch):
    calls = _capture_bridge(monkeypatch)

    result = mcp_module.add_camera_cut_track_to_level_sequence(
