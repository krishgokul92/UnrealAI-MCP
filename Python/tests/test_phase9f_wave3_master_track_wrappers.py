"""Pure-Python wrapper tests for Phase 9f Wave 3 master-track helpers."""
...
def test_add_master_track_to_level_sequence_maps_payload(monkeypatch):
    calls = _capture_bridge(monkeypatch)

    result = mcp_module.add_master_track_to_level_sequence(
